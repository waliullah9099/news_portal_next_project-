...
CREATE TABLE `catigories` (
    ...
    UNIQUE INDEX `catigories_name_key`(`name`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `news_list` ADD CONSTRAINT `news_list_catID_fkey` FOREIGN KEY (`catID`) REFERENCES `catigories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
